    ...
    <div class="flex-shrink-0 col-12 col-md-3 mb-4 mb-md-0">
      <div class="h-card mt-md-n5" style="margin-top:24px">
        ...
        <div class="clearfix d-flex d-md-block flex-items-center mb-4 mb-md-0">
          ...
          <div
            ...
            <h1 class="vcard-names pl-2 pl-md-0">
              <span class="p-name vcard-fullname d-block overflow-hidden">Hamed Hamine</span>
              
              <span class="p-nickname vcard-username d-block">hhamine</span>
        ...
        <div class="p-note user-profile-bio mb-3 js-user-profile-bio f4">
          <div>Ingénieur en Systèmes d&#39;Information, développeur Full-Stack orienté backend, consultant en solutions libres/Open Source et spécialiste  solutions Unix(Linux &amp;&amp; BSD).</div>
        </div>
          ...
          <div class="js-profile-editable-area d-flex flex-column d-md-block">
            <ul class="vcard-details">
              ...
              <li class="vcard-detail pt-1 css-truncate css-truncate-target hide-sm hide-md">
                ...
                <span class="p-label">🇧🇫 Burkina Faso, Bobo-Dioulasso</span>
              </li>
              ...
              <li class="vcard-detail pt-1 css-truncate css-truncate-target ">
                ...
                <a class="u-email link-gray-dark " href="mailto:hamine.sanou@nos3s.com">hamine.sanou@nos3s.com</a>
              </li>
              ...
              <li class="vcard-detail pt-1 css-truncate css-truncate-target ">
                ...
                <a rel="nofollow me" class="link-gray-dark" href="https://ton-domaine.dev">https://ton-domaine.dev</a>
            ...
            <div
              ...
              <div class="pinned-item-list-item-content">
                ...
                <div name="summary" class="pinned-item-desc text-gray text-small d-block mt-2 mb-3">
                  <h2 id="compétences-techniques">Compétences Techniques</h2>
<h3 id="langages-de-programmation">Langages de programmation</h3>
<ul>
<li><strong>C / C++</strong> (Certification en cours)</li>
<li><strong>Java</strong>, <strong>Python</strong>, <strong>Ruby on Rails</strong>, <strong>PHP (Laravel, Django)</strong></li>
<li><strong>HTML / CSS</strong>, <strong>Angular</strong>, <strong>React Native</strong></li>
<li><strong>Hugo(avec Markdown)</strong></li>
<li><strong>Bash scripting</strong>, <strong>SQL / PL/SQL</strong></li>
</ul>
<h3 id="frameworks-et-outils">Frameworks et outils</h3>
<ul>
<li><strong>Spring Boot</strong>, <strong>Qt Framework</strong></li>
<li><strong>Docker / Podman</strong>, <strong>KVM / QEMU</strong>, <strong>Kernel Linux</strong></li>
<li><strong>DBeaver CE</strong>, <strong>Logiciels de test API (ex : Bruno)</strong></li>
<li><strong>UML</strong> (modélisation avec <strong>Gaphor</strong>)</li>
<li>Suite bureautique : <strong>LibreOffice</strong></li>
</ul>
<h3 id="systèmes-dexploitation-maîtrisés">Systèmes d’exploitation maîtrisés</h3>
<ul>
<li><strong>Windows</strong></li>
<li><strong>Linux</strong> : Fedora, ArchLinux, Ubuntu</li>
<li><strong>BSD</strong> : OpenBSD, FreeBSD, NetBSD</li>
</ul>
<hr>
<h2 id="expériences-et-projets-clés">Expériences et Projets clés</h2>
<ul>
<li><strong>Aquapark System – Nos3S</strong> : Étude, analyse, conception et cahier des charges d’un système complet pour la gestion d’un parc aquatique.</li>
<li><strong>Système de Gestion des Cotisations – Nos3S</strong> : Développement d’une plateforme de gestion automatisée des dons pour un comité d’église.</li>
<li><strong>PortTradeConnect – Nos3S</strong> : Réalisation d’une plateforme d’échanges commerciaux et logistiques pour les acteurs portuaires.</li>
<li><strong>SOS Village d’Enfants – Nos3S</strong> : Conception et implémentation d’un système numérique sécurisé pour la collecte de dons.</li>
<li><strong>Système de Gestion d’Événements</strong> : Vente de tickets pour concerts et événements type Eventbrite / TicketMaster.</li>
<li><strong>ChatCoins Network</strong> : Conception d’une plateforme hybride de messagerie et réseau social avec monnaie interne (Matrix + Spring Boot + PostgreSQL + Neo4j).</li>
</ul>
<hr>
                </div>
...
<p><strong>Era</strong> est un projet personnel visant à créer une plateforme complète de <strong>gestion d’événements de dons de voting et de vente de tickets</strong>, inspirée de plateformes telles qu’Eventbrite, TicketMaster et Tickerama mais avec des modul encore plus revolutionnaire comme la gestion des siege grace au 3D.</p>
<p>La solution permet aux organisateurs de :</p>
<ul>
<li>Créer et gérer des événements (concerts, événements sportifs, conférences, campagnes caritatives…)</li>
<li>Générer et vendre des tickets électroniques pour chaque événement</li>
<li>Suivre les ventes, les participants et les statistiques en temps réel</li>
<li>Gérer des campagnes caritatives associées à des événements</li>
<li>Assurer un suivi des dons et contributions via la plateforme<br>
-etc.</li>
</ul>
<hr>
<h2 id="diagramme-de-classes">Diagramme de classes</h2>
<p>Le projet s’appuie sur un <strong>modèle relationnel structuré</strong>, comprenant les classes principales suivantes :</p>
                </div>
          ...
          <li class="col-12 col-md-6 col-lg-6 mb-3 d-flex flex-content-stretch">
            <div
              ...
              <div class="pinned-item-list-item-content">
                ...
                <div name="summary" class="pinned-item-desc text-gray text-small d-block mt-2 mb-3">
                  <h2 id="présentation-du-projet">Présentation du projet</h2>
<p>Ce projet a été réalisé au sein de <strong>Nos3S</strong> et vise à moderniser la gestion des dons mensuels d’un comité d’église à Bobo-Dioulasso.<br>
Le système permet de simplifier la gestion, renforcer la transparence et offrir une expérience fluide aux donateurs et aux administrateurs du comité.</p>
<p>Il s’agit d’une <strong>plateforme web complète pour la gestion automatisée des dons</strong>, incluant :</p>
<ul>
<li>Enregistrement et suivi des dons</li>
<li>Gestion des donateurs</li>
<li>Intégration d’un paiement en ligne via LigdiCash</li>
<li>Envoi automatique de reçus et notifications (Email, SMS, WhatsApp)</li>
<li>Génération de rapports financiers</li>
</ul>
<hr>
<h2 id="fonctionnalités-principales">Fonctionnalités principales</h2>
<ul>
<li><strong>Gestion des donateurs</strong> : création, modification, suppression et consultation des fiches donateurs, avec historique complet</li>
<li><strong>Gestion des dons</strong> : enregistrement automatique ou manuel des dons, suivi mensuel et état de paiement</li>
<li><strong>Paiement en ligne</strong> : sécurisé via API LigdiCash</li>
<li><strong>Notifications automatiques</strong> : envoi de reçus et messages de remerciement</li>
<li><strong>Tableau de bord administratif</strong> : statistiques sur les dons, nombre de donateurs, répartition mensuelle, export PDF/Excel</li>
</ul>
<hr>
<h2 id="technologies-utilisées">Technologies utilisées</h2>
<ul>
<li><strong>Framework :</strong> Ruby on Rails</li>
<li><strong>Base de données :</strong> SQLite ou PostgreSQL</li>
<li><strong>Architecture :</strong> Modèle templating (sans API externe)</li>
<li><strong>Hébergement :</strong> Cloud, serveur distant ou local selon le choix du client</li>
<li><strong>Intégrations externes :</strong> Paiement et messagerie via API LigdiCash et WhatsApp Business</li>
</ul>
<hr>
<h2 id="objectif-et-impact">Objectif et impact</h2>
<p>La plateforme permet de centraliser et automatiser la gestion des dons, offrant aux administrateurs une <strong>vision claire et traçable des contributions</strong> et aux donateurs une <strong>expérience simple et sécurisée</strong> pour effectuer leurs versements.<br>
L’étude, l’analyse, la conception et l’élaboration du cahier des charges ont été réalisées dans le cadre professionnel de <strong>Nos3S</strong>, garantissant un projet structuré et fiable.</p>
                </div>
          ...
          <li class="col-12 col-md-6 col-lg-6 mb-3 d-flex flex-content-stretch">
            <div
              ...
              <div class="pinned-item-list-item-content">
                ...
                <div name="summary" class="pinned-item-desc text-gray text-small d-block mt-2 mb-3">
                  <h2 id="présentation-du-projet">Présentation du projet</h2>
<p>Ce projet a été réalisé au sein de <strong>Nos3S</strong> et vise à créer une plateforme numérique complète pour faciliter et sécuriser la collecte de dons pour l’ONG <strong>SOS Village d’Enfants</strong>.</p>
<p>Le système permet :</p>
<ul>
<li>La création et la gestion de campagnes de dons</li>
<li>L’accès des donateurs via liens ou QR codes</li>
<li>La réalisation de paiements en ligne (mobile money, carte bancaire, PayPal…)</li>
<li>Le suivi transparent des dons et des projets financés</li>
</ul>
<hr>
<h2 id="composants-et-fonctionnalités-principales">Composants et fonctionnalités principales</h2>
<h3 id="portail-web-donateur">Portail Web Donateur</h3>
<ul>
<li>Accès aux campagnes : actives, clôturées ou en attente</li>
<li>Réalisation de dons via plusieurs moyens de paiement</li>
<li>Accès rapide via QR Code</li>
<li>Historique personnel des dons</li>
<li>Visualisation en temps réel des montants collectés par campagne</li>
<li>Reçu électronique automatique</li>
</ul>
<h3 id="espace-administratif-ong">Espace Administratif ONG</h3>
<ul>
<li>Gestion des campagnes : création, modification, clôture</li>
<li>Tableau de bord avec statistiques globales</li>
<li>Suivi détaillé des contributions (montant, donateur, statut)</li>
<li>Export de rapports Excel/PDF</li>
<li>Publication d’actualités sur les projets financés</li>
</ul>
<h3 id="fonctionnalités-complémentaires">Fonctionnalités complémentaires</h3>
<ul>
<li>Notifications automatiques par email ou SMS</li>
<li>Partage des campagnes sur les réseaux sociaux</li>
<li>Mise en avant de projets prioritaires</li>
</ul>
<hr>
<h2 id="technologies-utilisées">Technologies utilisées</h2>
<ul>
...
<li><strong>Architecture :</strong> Modèle templating (sans API externe)</li>
<li><strong>Frontend :</strong> Interface responsive avec Tailwind CSS et Bootstrap</li>
<li><strong>Paiement en ligne :</strong> API LigdiCash</li>
</ul>
<hr>
<h2 id="objectif-et-impact">Objectif et impact</h2>
<p>Cette plateforme vise à <strong>simplifier et sécuriser la collecte de dons</strong>, offrant aux donateurs une expérience fluide et transparente, et aux administrateurs un suivi précis et un reporting clair.</p>
                </div>
          ...
          <li class="col-12 col-md-6 col-lg-6 mb-3 d-flex flex-content-stretch">
            <div
              ...
              <div class="pinned-item-list-item-content">
                ...
                <div name="summary" class="pinned-item-desc text-gray text-small d-block mt-2 mb-3">
                  <h2 id="présentation-du-projet">Présentation du projet</h2>
<p>Le projet <em>Aquapark System</em> vise à mettre en place un système numérique complet pour automatiser la gestion des activités du parc aquatique <strong>Café du Chef</strong>.<br>
Il comprend deux solutions interconnectées :</p>
<ol>
<li><strong>Application de gestion interne</strong> pour le personnel et l&rsquo;administration</li>
<li><strong>Application mobile client</strong> pour les visiteurs</li>
</ol>
<p>Le système intègre également des fonctionnalités de paiement, de publicité et de services complémentaires.</p>
<hr>
<h2 id="composants-du-système">Composants du système</h2>
<h3 id="1-logiciel-de-gestion-interne--café-du-chef-manager-pro">1. Logiciel de gestion interne – Café du Chef Manager Pro</h3>
          ...
          <li class="col-12 col-md-6 col-lg-6 mb-3 d-flex flex-content-stretch">
            <div
              ...
              <div class="pinned-item-list-item-content">
                ...
                <div name="summary" class="pinned-item-desc text-gray text-small d-block mt-2 mb-3">
                  <h2 id="présentation-du-projet">Présentation du projet</h2>
<p>Ce projet a été réalisé au sein de <strong>Nos3S</strong> et vise à faciliter les échanges commerciaux et logistiques entre différents acteurs économiques opérant depuis les ports.</p>
<p>La plateforme <strong>PortTradeConnect</strong> permet de centraliser, sécuriser et fluidifier les transactions entre commerçants, transitaires, transporteurs, institutions financières et autres intervenants de la chaîne logistique.</p>
<p>Elle répond à plusieurs problématiques courantes :</p>
<ul>
<li>Absence de plateforme commune pour mettre en relation les acteurs</li>
<li>Difficulté d’identification et de suivi des offres disponibles</li>
<li>Multiplicité des canaux de communication</li>
<li>Manque de traçabilité et de transparence</li>
<li>Complexité des paiements entre les différentes parties</li>
</ul>
<hr>
<h2 id="objectifs-du-projet">Objectifs du projet</h2>
<p>La plateforme a pour objectifs de :</p>
                </div>
